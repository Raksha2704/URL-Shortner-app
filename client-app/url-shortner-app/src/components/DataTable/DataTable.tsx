...
// import type { UrlData } from "../../interface/UrlData";
// import { Link } from "react-router-dom";
// import { serverUrl, baseUrl } from '../../helpers/Constants';
// import axios from 'axios';
...
//     try {
//       const frontendShortUrl = `${baseUrl}/shortUrl/${shortUrl}`;
//       await navigator.clipboard.writeText(frontendShortUrl);
//       alert(`URL copied: ${frontendShortUrl}`);
//     } catch (error) {
...
//         <td className="px-6 py-3">
//           <Link
//             to={`${baseUrl}/shortUrl/${item.shortUrl}`}
//             target="_blank"
//             rel="noreferrer noopener"
//           >
//             {item.shortUrl}
